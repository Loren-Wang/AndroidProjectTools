...
public class ActivityUtils {
    ...
    //权限请求键值对
    private static Map<Integer,PermissionRequestCallback> permissionRequestCallbackMap = new HashMap<>();
    ...
    public void goToRequestPermisstions(Activity activity, @NonNull String[] permisstions, int permissionsRequestCode
        ...
        if(Build.VERSION.SDK_INT < Build.VERSION_CODES.M){
            if(permissionRequestCallback != null) {
                permissionRequestCallback.perissionRequestSuccessCallback(ParamsAndJudgeUtils.paramesArrayToList(permisstions)
