...
import static com.lorenwang.netoptions.android.NetRequestUtils.NETWORK_DATA_REQUEST_FAIL_CASE_TIME_INTERVALIN;
import static com.lorenwang.netoptions.android.NetworkOptionsConstant.NETWORK_DATA_REQUEST_FAIL_CASE_URL_NOT_EFFECTIVE;
...
public abstract class BaseNetworkOptions {
    ...
    protected boolean isTimeIntervalIn(String requestRecordDtoKey) {
        ...
        if (networkRequestRecordDto != null) {
            if (ParamsAndJudgeUtils.getMillisecond() - networkRequestRecordDto.requestTime <= sameRequestUrlPathIntervel) {
