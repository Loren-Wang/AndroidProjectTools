...
public final class LogUtils {
	...
	private static String saveLogNamePath = null;//日志保存地址

	private static void saveLog(String type, String tag, String message){
//
//		try {
//			if(saveLogNamePath == null){
//				saveLogNamePath = AppCommon.PROJECT_FILE_DIR_APP_ALL_LOG + ParamsAndJudgeUtils.getFormatedDateNowTime("yyyy-MM-dd HH:mm:ss") + ".txt";
//			}
//
//			if(!CheckUtils.isNotEmptyOrNull(type)){
//				type = "";
//			}
//			if(!CheckUtils.isNotEmptyOrNull(tag)){
//				tag = "";
//			}
//			if(!CheckUtils.isNotEmptyOrNull(message)){
//				message = "";
//			}
//
