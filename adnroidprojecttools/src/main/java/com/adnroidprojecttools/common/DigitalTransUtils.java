...
public class DigitalTransUtils {
    private static DigitalTransUtils digitalTransUtils;
    public static DigitalTransUtils getInstance(){
        if(digitalTransUtils == null){
            digitalTransUtils = new DigitalTransUtils();
        }
        return digitalTransUtils;
    }
